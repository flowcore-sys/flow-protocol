...
REM sm_75=Turing(RTX2000), sm_86=Ampere(RTX3000), sm_89=Ada(RTX4000), sm_100=RTX5080, sm_110=RTX5090
nvcc -c -O3 -use_fast_math -gencode=arch=compute_75,code=sm_75 -gencode=arch=compute_86,code=sm_86 -gencode=arch=compute_89,code=sm_89 -gencode=arch=compute_100,code=sm_100 -gencode=arch=compute_110,code=sm_110 -gencode=arch=compute_110,code=compute_110 -I include -I src -o build-gpu/keccak256_cuda.obj src/miner/keccak256_cuda.cu
